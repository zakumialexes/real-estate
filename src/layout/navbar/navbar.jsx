...
const settings = ["My Profile", "Message", "Purchase History", "Account", "Help", "Logout"]
export const DesktopNav = ({ anchorElUser, handleOpenUserMenu, handleCloseUserMenu, sticky, dashboard, large }) => {
    return (
        <Container
            component="header"
            maxWidth={false}
        ...
        >
            {!dashboard && (
                <Box sx={{ gap: 1 }} className={Style.center}>
                    <Avatar className={Style.logo} src={"asset/header-logo2.png"} alt="" />
                    <Typography component="h2" fontWeight="bold" fontSize="28px" color="#484848">
                        Shwe Real Estate
                    </Typography>
                </Box>
            )}

            <Stack direction={"row"} gap={2} alignItems="center" sx={dashboard && { ml: "auto" }}>
                        ...
                        <Box sx={{ flexGrow: 0 }}>
                            ...
                            >
                                <Box sx={{ mb: "20px", display: "flex", gap: 2 }}>
                                    <Avatar sx={{ borderRadius: "2px" }} src="https://loremflickr.com/320/240" />
                                    <Box>
                                        <Typography className={Style.text}> Ali Tufan</Typography>
                                        <Typography className={Style.text}>alitufan@gmail.com</Typography>
                                    </Box>
                                </Box>
                                {settings.map((setting) => (
                                    <MenuItem className={Style.menuItem} key={setting} onClick={handleCloseUserMenu}>
        ...
        >
            ...
            <List sx={{}}>
                {navlinks.map((item, i) => (
                    ...
                    >
                        <FontAwesomeIcon className={Style.text} style={{ marginRight: "8px" }} icon={item.icon} />
