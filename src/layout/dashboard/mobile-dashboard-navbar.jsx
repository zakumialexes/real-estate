...
const links = [
    ...
    { id: "add-new-listing", icon: faBarsStaggered, to: "#", title: "add new listing" },
...
const MobileDashboardNavbar = () => {
    ...
    return (
        <>
            <Container component="nav" maxWidth="false" sx={{ marginY: "10px", p: { xs: 0, lg: 3 } }}>
            ...
            <Collapse in={open} timeout="auto" unmountOnExit>
                <Box component="ul" className={style.ul}>
                    {links.map((item, i) => (
                        <ListsItem handleClick={handleClick} setActive={setActive} active={active} key={i} {...item} />
                    ))}
                </Box>
            </Collapse>
        </>
