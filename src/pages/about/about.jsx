...
import { useGetTeamQuery } from "../../api/api"

const About = () => {
    const { data: cardData, isSuccess } = useGetTeamQuery()
                    ...
                    <Grid container spacing={2}>
                        <Grid item lg={7} md={12}>
                            ...
                            >
                                ...
                                vulputate porttitor sed feugiat nunc. Mauris ac consectetur ante, dapibus gravida
                                tellus. Nullam aliquet eleifend dapibus. Cras sagittis, ex euismod lacinia tempor,
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} lg={4}>
                                        ...
                                        >
                                            <Box>
                                                <PersonIcon
                                                    sx={{ fontSize: "4rem", color: "#ff5a5f", height: "100%" }}
                                                />
                                            </Box>
                        ...
                        <Card className={aboutStyle.cards}>
                            <Stack spacing={2} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                                ...
                                <Typography variant="body1" sx={{ fontSize: "0.9rem" }}>
                                    Aliquam dictum elit vitae mauris facilisis at dictum urna dignissim donec vel lectus
                                    vel felis.
                                </Typography>
                            </Stack>
                        </Card>
