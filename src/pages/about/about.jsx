...
const About = () => {
    ...
    function SampleNextArrow({ onClick }) {
        return (
            <div>
                <button className={aboutStyle.nextBtn} onClick={onClick}>
    ...
    function SamplePrevArrow({ onClick }) {
        return (
            <div>
                <button className={aboutStyle.preBtn} onClick={onClick}>
        ...
        <Stack>
            ...
            >
                <Grid container spacing={2}>
                    <Grid item lg={7} md={12}>
                        <Typography
                            ...
                            sx={{
                                ...
                                fontSize: { md: "1.2rem !important" },
                            }}
                            className={aboutStyle.bodyText}
                        >
                            Mauris ac consectetur ante, dapibus gravida tellus. Nullam aliquet eleifend dapibus. Cras
                            sagittis, ex euismod lacinia tempor.
                        </Typography>
                        <Typography
                            variant="body1"
                            sx={{
                        ...
                        >
                            ...
                            vulputate porttitor sed feugiat nunc. Mauris ac consectetur ante, dapibus gravida tellus.
                            Nullam aliquet eleifend dapibus. Cras sagittis, ex euismod lacinia tempor, lectus orci
                    ...
                    <Grid item lg={5} md={12} sx={{ width: "100%", height: "100%" }}>
                        <Box sx={{ position: "relative", width: "100%", height: "100%" }}>
                            <img className={aboutStyle.bodyImg} src={Mission} alt="" />
                            <button onClick={handleOpen} className={aboutStyle.play}>
                                <PlayArrowOutlinedIcon sx={{ fontSize: "70px", fontWeight: "50", color: "#fff" }} />
            ...
            <Modal open={open} onClose={handleClose} aria-labelledby="Youtube video" aria-describedby="Youtube video">
                <Box sx={style}>
                    <iframe
            ...
            >
                ...
                <Typography variant="subtitle1">We provide full service at every step.</Typography>
            </Stack>
            <Grid className={aboutStyle.container} container spacing={3} direction="row" alignItems="center">
                    ...
                    <Card className={aboutStyle.cards}>
                        <Stack spacing={2} sx={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                            ...
                            <Typography variant="body1" sx={{ fontSize: "0.9rem" }}>
                                Aliquam dictum elit vitae mauris facilisis at dictum urna dignissim donec vel lectus vel
                                felis.
                            </Typography>
                        </Stack>
                    </Card>
                            ...
                            <Card key={data.id} className={aboutStyle.TeamCards}>
                                <Stack padding={1}>
                                    <Box className={aboutStyle.ImgCom}>
                                        <img className={aboutStyle.TeamImg} src={data.img} alt="Team profile" />
            ...
            <Stack className={aboutStyle.container} spacing={2} sx={{ margin: "50px 0px" }}>
                ...
                >
                    ...
                    <Typography variant="subtitle1">We only work with the best companies around the globe</Typography>
                </Stack>
                <Grid container spacing={3} direction="row" alignItems="center" className={aboutStyle.container}>
                    <Grid item className={aboutStyle.partnerIcon} lg={2.4} md={4} sm={6} xs={12}>
