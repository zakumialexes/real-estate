    ...
    return (
        <>
            <div id="plans" className={planStyle.container}>
                ...
                {data?.map((data, index) => (
                    <Box key={index} mb={2}>
                        <div className={planStyle.planContainer} onClick={() => toggle(index)}>
                            <p align="center">
                                <b>First Floor </b>
                                Size:<b>1267 Sq ft </b>
                                Rooms:<b>670 Sq ft </b>
                            ...
                            <FontAwesomeIcon
                                icon={faAngleDown}
                                className={`${planStyle.icon} ${selected === index ? planStyle.iconActive : ""}`}
                            />
                        </div>
                        <div className={`${planStyle.imageContainer} ${selected === index ? planStyle.show : ""}`}>
                            <img
