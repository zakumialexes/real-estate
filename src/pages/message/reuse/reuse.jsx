...
import { Box, TextField, Typography, styled, IconButton, Grid, Avatar, Input, Button } from "@mui/material"
...
export const WriteMessage = ({ sendData, userId }) => {
    ...
    return (
        <Box className={reuseStyle.messageBox}>
            ...
            />
            <Button color="error" sx={{ padding: "10px" }} variant="contained" onClick={() => onClickHandler()}>
                Send
            </Button>
        </Box>
    )
